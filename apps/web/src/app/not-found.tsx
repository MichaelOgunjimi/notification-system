  ...
  return (
    ...
    >
      <header className="px-4 pt-4 sm:px-6 lg:px-8">
        <nav
          className="site-nav mx-auto flex h-16 w-full max-w-[1240px] items-center px-3 sm:px-4"
        ...
        >
          ...
          <Link
            href={docsUrl()}
            className="ml-auto text-[12px] text-[var(--site-muted)] transition-colors duration-300 hover:text-[var(--site-ink)]"
          >
            Documentation
          </Link>
        </nav>
      ...
      <section className="mx-auto grid min-h-[calc(100dvh-84px)] w-full max-w-[1160px] items-center px-4 py-20 sm:px-6 lg:px-8">
        <div className="max-w-[760px]">
          ...
          <p className="mt-7 max-w-[520px] text-[16px] leading-7 text-[var(--site-muted)]">
            The address may have changed, or the page may no longer exist. The documentation and
            homepage are still available.
          </p>
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              href={docsUrl()}
              className="site-secondary-action inline-flex h-12 items-center justify-center px-5 text-[13px] font-medium"
            >
              Browse the docs
            </Link>
          </div>
