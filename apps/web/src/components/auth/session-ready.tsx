...
export function SessionReady() {
  ...
  if (user === undefined) return <AuthShell><div aria-live="polite" className="flex items-center gap-3 text-[14px] text-[var(--site-muted-bright)]"><SpinnerGap size={20} className="animate-spin" /> Loading your session</div></AuthShell>;
