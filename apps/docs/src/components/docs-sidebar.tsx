...
const SIDEBAR_SECTIONS: SidebarSection[] = [
  {
    ...
    items: [
      { slug: "introduction", href: "/introduction", label: "Introduction" },
      { slug: "quickstart", href: "/quickstart", label: "Quickstart" },
    ],
  },
  {
    label: "Guides",
    items: [
      ...
      { slug: "channels", href: "/channels", label: "Channels" },
      { slug: "templates", href: "/templates", label: "Templates" },
      { slug: "delivery", href: "/delivery", label: "Delivery Pipeline" },
    ],
  },
  {
    label: "Reference",
    items: [
      { slug: "api-reference", href: "/api-reference", label: "API Reference" },
      { slug: "architecture", href: "/architecture", label: "Architecture" },
      { slug: "webhooks", href: "/webhooks", label: "Webhooks" },
    ],
  },
];
