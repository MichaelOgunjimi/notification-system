...
@pytest.mark.asyncio
async def test_api_key_with_sql_injection_returns_401(client: AsyncClient) -> None:
    resp = await client.get(
        "/api/v1/events/00000000-0000-0000-0000-000000000000",
...
@pytest.mark.asyncio
async def test_api_key_with_null_bytes_returns_401(client: AsyncClient) -> None:
    resp = await client.get(
        "/api/v1/events/00000000-0000-0000-0000-000000000000",
        headers={"X-API-Key": "nk_\x00test"},
    )
    assert resp.status_code in (401, 422)


@pytest.mark.asyncio
async def test_oversized_api_key_returns_401(client: AsyncClient) -> None:
    resp = await client.get(
        "/api/v1/events/00000000-0000-0000-0000-000000000000",
...
@pytest.mark.asyncio
async def test_api_key_with_unicode_returns_401(client: AsyncClient) -> None:
    resp = await client.get(
        "/api/v1/events/00000000-0000-0000-0000-000000000000",
        headers=[(b"X-API-Key", "nk_🔐テスト".encode())],
    )
    assert resp.status_code in (401, 422)
