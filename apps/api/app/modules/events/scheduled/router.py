...
from app.modules.credentials.dependencies import (
    ScheduledEventsReadApiKeyDep,
    ScheduledEventsWriteApiKeyDep,
    api_key_filter_id,
)
...
from app.modules.events.scheduled.schemas import ScheduledEventCreate, ScheduledEventResponse
...
async def list_scheduled_events(
    ...
    *,
    db: SessionDep,
    api_key: ScheduledEventsReadApiKeyDep,
