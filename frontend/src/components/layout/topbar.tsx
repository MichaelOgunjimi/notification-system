...
export function Topbar({ onOpenMobileNav, breadcrumbs }: TopbarProps) {
  return (
    <header className="sticky top-0 z-30 flex h-12 shrink-0 items-center gap-3 border-b border-[var(--gray-3)] bg-[color:rgba(0,0,0,0.88)] px-4 backdrop-blur-xl sm:px-5">
      {/* Mobile hamburger */}
      <button
        type="button"
