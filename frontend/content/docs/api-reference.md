...
```bash
curl -X GET "http://localhost:8000/api/v1/events?page=1&per_page=2&priority=high" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/events/3d434cf3-2f63-4a82-aae4-fbead6877445 \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/notifications?channel=email&status=delivered" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/notifications/f8ce0a5f-9d95-4483-95d7-bda38ab718e8 \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/templates?channel=email" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/templates/799524b8-fdc7-4f56-8a07-3b00bbc377af \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X PUT http://localhost:8000/api/v1/templates/799524b8-fdc7-4f56-8a07-3b00bbc377af \
  -H "Content-Type: application/json" \
  -H "X-API-Key: PROJECT_KEY" \
...
```bash
curl -X DELETE http://localhost:8000/api/v1/templates/799524b8-fdc7-4f56-8a07-3b00bbc377af \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X POST http://localhost:8000/api/v1/templates/799524b8-fdc7-4f56-8a07-3b00bbc377af/preview \
  -H "Content-Type: application/json" \
  -H "X-API-Key: PROJECT_KEY" \
...
```bash
curl -X GET "http://localhost:8000/api/v1/scheduled-events?status=scheduled" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X DELETE http://localhost:8000/api/v1/scheduled-events/39ac7bf3-c4f6-4a1f-ab1a-996f1fcf2d5d \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/suppressions?channel=email" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X DELETE http://localhost:8000/api/v1/suppressions/90763e0e-e417-44a5-b0d4-ec9793fdf52f \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/dead-letter?status=active&channel=sms" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/dead-letter/588d499e-0f53-4ac4-b7ec-a6ce77861d2e \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X POST http://localhost:8000/api/v1/dead-letter/588d499e-0f53-4ac4-b7ec-a6ce77861d2e/retry \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X POST http://localhost:8000/api/v1/dead-letter/588d499e-0f53-4ac4-b7ec-a6ce77861d2e/discard \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X PUT http://localhost:8000/api/v1/alerts/03f80ee5-09d8-4f88-aee1-50b70b538795 \
  -H "Content-Type: application/json" \
  -H "X-API-Key: PROJECT_KEY" \
...
```bash
curl -X DELETE http://localhost:8000/api/v1/alerts/03f80ee5-09d8-4f88-aee1-50b70b538795 \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/analytics?date_from=2026-04-01T00:00:00Z&date_to=2026-04-17T23:59:59Z" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/analytics/trends?date_from=2026-04-15T00:00:00Z&date_to=2026-04-17T23:59:59Z&granularity=day" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/audit-log?action=api_key.created&page=1" \
...
```bash
curl -X GET "http://localhost:8000/api/v1/usage?endpoint=/events&from=2026-04-17T00:00:00Z" \
  -H "X-API-Key: PROJECT_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/settings/api-keys?page=1&per_page=25" \
  -H "X-API-Key: MASTER_KEY"
```
...
```bash
curl -X DELETE http://localhost:8000/api/v1/settings/api-keys/2f44dad2-41a2-4f4c-8d7a-a6ca73f08953 \
  -H "X-API-Key: MASTER_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/settings/channels \
  -H "X-API-Key: MASTER_KEY"
```
...
```bash
curl -X GET http://localhost:8000/api/v1/settings/retry-policies \
  -H "X-API-Key: MASTER_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/admin/analytics?date_from=2026-04-01T00:00:00Z&date_to=2026-04-17T23:59:59Z" \
  -H "X-API-Key: MASTER_KEY"
```
...
```bash
curl -X GET "http://localhost:8000/api/v1/admin/usage?endpoint=/events&from=2026-04-17T00:00:00Z" \
  -H "X-API-Key: MASTER_KEY"
```
